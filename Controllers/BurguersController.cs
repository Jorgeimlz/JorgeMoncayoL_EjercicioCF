...
namespace JorgeMoncayoL_EjercicioCF.Controllers
{
    public class BurguersController : Controller
    {
        ...
        public BurguersController(JorgeMoncayoL_EjercicioCFContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Burguer != null ? 
                          ...
                          Problem("Entity set 'JorgeMoncayoL_EjercicioCFContext.Burguer'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'JorgeMoncayoL_EjercicioCFContext.Burguer'  is null.");
            }
            var burguer = await _context.Burguer.FindAsync(id);
            if (burguer != null)
            {
        ...
        {
          return (_context.Burguer?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
